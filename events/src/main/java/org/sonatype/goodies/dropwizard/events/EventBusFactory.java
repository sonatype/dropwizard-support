...
/**
 * Helper to create {@link EventBus} instances.
 *
 * @since ???
 */
public class EventBusFactory
{
  ...
  public static EventBus create(final String name) {
    return newEventBus(name, directExecutor());
  }

  public static EventBus create(final String name, final Executor executor) {
